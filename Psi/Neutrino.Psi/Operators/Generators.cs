...
public static class Generators
{
    ...
    {
        return Sequence(pipeline, Enumerate(initialValue, generateNext, count), interval, alignmentDateTime, keepOpen, name);
    }
    ...
    {
        return Sequence(pipeline, Enumerate(initialValue, generateNext), interval, alignmentDateTime, keepOpen: true, name);
    }
    ...
    {
        return new Generator<T>(pipeline, enumerable.GetEnumerator(), startTime, isInfiniteSource: keepOpen, name);
    }
    ...
    {
        return Sequence(pipeline, new[] { value }, default, null, keepOpen: true, name);
    }
    ...
    {
        return Sequence(pipeline, new[] { value }, default, null, keepOpen: false, name);
    }
    ...
    {
        return Sequence(pipeline, Enumerable.Repeat(value, count), interval, alignmentDateTime, keepOpen, name);
    }
    ...
    {
        return Sequence(pipeline, Enumerate(value, x => x), interval, alignmentDateTime, keepOpen: true, name);
    }
    ...
    {
        return Sequence(pipeline, Enumerable.Range(start, count), interval, alignDateTime, keepOpen, name);
    }
