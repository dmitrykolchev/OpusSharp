// <copyright file="VectorProcessors.cs">
...
public static partial class Operators
{
    ...
    {
        ParallelFixedLength<TIn, TOut> p = new(source.Out.Pipeline, vectorSize, streamTransform, outputDefaultIfDropped, defaultValue, name, defaultParallelDeliveryPolicy);
    ...
    public static IProducer<TIn[]> Parallel<TIn>(
        ...
        DeliveryPolicy defaultParallelDeliveryPolicy = null)
    {
        ParallelFixedLength<TIn, TIn> p = new(source.Out.Pipeline, vectorSize, streamAction, name, defaultParallelDeliveryPolicy);
    ...
    public static IProducer<TOut[]> Parallel<TIn, TOut>(
        ...
        DeliveryPolicy defaultParallelDeliveryPolicy = null)
    {
        ParallelVariableLength<TIn, TOut> p = new(source.Out.Pipeline, streamTransform, outputDefaultIfDropped, defaultValue, name, defaultParallelDeliveryPolicy);
        return PipeTo(source, p, deliveryPolicy);
    }
    ...
    public static IProducer<TIn[]> Parallel<TIn>(
        ...
        DeliveryPolicy defaultParallelDeliveryPolicy = null)
    {
        ParallelVariableLength<TIn, TIn> p = new(source.Out.Pipeline, streamAction, name, defaultParallelDeliveryPolicy);
        source.PipeTo(p, deliveryPolicy);
        return source;
    }
    ...
    public static IProducer<TOut> Parallel<TIn, TBranchKey, TBranchIn, TBranchOut, TOut>(
        ...
        DeliveryPolicy defaultParallelDeliveryPolicy = null)
    {
        ParallelSparseSelect<TIn, TBranchKey, TBranchIn, TBranchOut, TOut> p = new(
            source.Out.Pipeline,
            splitter,
            streamTransform,
            outputCreator,
    ...
    public static IProducer<Dictionary<TBranchKey, TBranchOut>> Parallel<TBranchKey, TBranchIn, TBranchOut>(
        ...
        DeliveryPolicy defaultParallelDeliveryPolicy = null)
    {
        ParallelSparseSelect<Dictionary<TBranchKey, TBranchIn>, TBranchKey, TBranchIn, TBranchOut, Dictionary<TBranchKey, TBranchOut>> p = new(
            source.Out.Pipeline,
            _ => _,
            streamTransform,
            _ => _,
    ...
    public static IProducer<TIn> Parallel<TIn, TBranchKey, TBranchIn>(
        ...
        DeliveryPolicy defaultParallelDeliveryPolicy = null)
    {
        ParallelSparseDo<TIn, TBranchKey, TBranchIn> p = new(
            source.Out.Pipeline,
            splitter,
            streamAction,
            branchTerminationPolicy,
    ...
    public static IProducer<Dictionary<TBranchKey, TBranchIn>> Parallel<TBranchKey, TBranchIn>(
        ...
        DeliveryPolicy defaultParallelDeliveryPolicy = null)
    {
        ParallelSparseDo<Dictionary<TBranchKey, TBranchIn>, TBranchKey, TBranchIn> p = new(
            source.Out.Pipeline,
            _ => _,
            streamAction,
            branchTerminationPolicy,
    ...
    public static IProducer<Dictionary<TBranchKey, TBranchOut>> Parallel<TIn, TBranchKey, TBranchIn, TBranchOut>(
        ...
        DeliveryPolicy defaultParallelDeliveryPolicy = null)
    {
        ParallelSparseSelect<TIn, TBranchKey, TBranchIn, TBranchOut, Dictionary<TBranchKey, TBranchOut>> p = new(
            source.Out.Pipeline,
            splitter,
            (k, s) => streamTransform(s),
            _ => _,
