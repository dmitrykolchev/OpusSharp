// <copyright file="Interpolators.cs">
...
public static partial class Operators
{
    ...
    public static IProducer<TInterpolation> Interpolate<T, TInterpolation>(
        ...
        string name = null)
    {
        IProducer<int> clock = Generators.Repeat(source.Out.Pipeline, 0, samplingInterval, alignmentDateTime);
    ...
    public static IProducer<TInterpolation> Interpolate<T, TClock, TInterpolation>(
        ...
        string name = null)
    {
        Fuse<TClock, T, TInterpolation, TInterpolation> fuse = new(
            source.Out.Pipeline,
            interpolator,
            (clk, data) => data[0],
