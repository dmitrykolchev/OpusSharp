...
public static partial class Operators
{
    ...
    public static double? Std(this IEnumerable<int?> source)
    {
        IEnumerable<int> sourceValues = source.Where(d => d.HasValue).Select(d => d.Value);
        return sourceValues.Count() == 0 ? null : sourceValues.Std();
    }
    ...
    public static double? Std(this IEnumerable<long?> source)
    {
        IEnumerable<long> sourceValues = source.Where(d => d.HasValue).Select(d => d.Value);
        return sourceValues.Count() == 0 ? null : sourceValues.Std();
    }
    ...
    public static float? Std(this IEnumerable<float?> source)
    {
        IEnumerable<float> sourceValues = source.Where(d => d.HasValue).Select(d => d.Value);
        return sourceValues.Count() == 0 ? null : sourceValues.Std();
    }
    ...
    public static double? Std(this IEnumerable<double?> source)
    {
        IEnumerable<double> sourceValues = source.Where(d => d.HasValue).Select(d => d.Value);
        return sourceValues.Count() == 0 ? null : sourceValues.Std();
    }
    ...
    public static decimal? Std(this IEnumerable<decimal?> source)
    {
        IEnumerable<decimal> sourceValues = source.Where(d => d.HasValue).Select(d => d.Value);
        return sourceValues.Count() == 0 ? null : sourceValues.Std();
    }
