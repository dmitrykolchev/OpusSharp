...
public static partial class Operators
{
    ...
    public static IProducer<TOut> Fuse<TPrimary, TSecondary, TOut>(
        ...
        string name = null)
    {
        Fuse<TPrimary, TSecondary, TSecondary, TOut> fuse = new(
        ...
        int i = 0;
        foreach (IProducer<TSecondary> input in secondaries)
        {
    ...
    public static IProducer<TOut> Fuse<TPrimary, TSecondary, TInterpolation, TOut>(
        ...
        string name = null)
    {
        Fuse<TPrimary, TSecondary, TInterpolation, TOut> fuse = new(
            primary.Out.Pipeline,
            interpolator,
            outputCreator,
            secondaries.Count(),
