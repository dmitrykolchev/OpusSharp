// <copyright file="RealInterval.cs">
...
public class RealInterval : Interval<double, double, IntervalEndpoint<double>, RealInterval>
{
    ...
    {
        return Merge(intervals, (left, right) => new(left, right));
    }
    ...
    {
        return new(left, inclusive, true, double.MaxValue, false, false);
    }
    ...
    {
        return new(double.MinValue, false, false, right, inclusive, true);
    }
    ...
    {
        return Translate(span, (lp, li, lb, rp, ri, rb) => new(lp, li, lb, rp, ri, rb));
    }
    ...
    {
        return Scale(left, right, (lp, li, lb, rp, ri, rb) => new(lp, li, lb, rp, ri, rb));
    }
