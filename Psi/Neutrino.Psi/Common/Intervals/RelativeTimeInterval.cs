// <copyright file="RelativeTimeInterval.cs">
...
public class RelativeTimeInterval : Interval<TimeSpan, TimeSpan, IntervalEndpoint<TimeSpan>, RelativeTimeInterval>, IEquatable<RelativeTimeInterval>
{
    ...
    /// </summary>
    protected override TimeSpan PointMinValue => TimeSpan.MinValue;

    /// <summary>
    /// Gets the point maximum value.
    /// </summary>
    protected override TimeSpan PointMaxValue => TimeSpan.MaxValue;
    ...
    {
        return new(-duration, inclusive, true, TimeSpan.Zero, true, true);
    }
    ...
    {
        return new(TimeSpan.Zero, true, true, duration, inclusive, true);
    }
    ...
    {
        return Merge(intervals, (left, right) => new RelativeTimeInterval(left, right));
    }
    ...
    {
        return new(left, inclusive, true, TimeSpan.MaxValue, false, false);
    }
    ...
    {
        return new(TimeSpan.MinValue, false, false, right, inclusive, true);
    }
    ...
    {
        return Translate(span, (lp, li, lb, rp, ri, rb) => new RelativeTimeInterval(lp, li, lb, rp, ri, rb));
    }
    ...
    {
        return Scale(left, right, (lp, li, lb, rp, ri, rb) => new RelativeTimeInterval(lp, li, lb, rp, ri, rb));
    }
    ...
    {
        return (obj is RelativeTimeInterval other) && Equals(other);
    }

    /// <inheritdoc/>
    public bool Equals(RelativeTimeInterval other)
    {
        return (LeftEndpoint.Point, LeftEndpoint.Inclusive, LeftEndpoint.Bounded, RightEndpoint.Point, RightEndpoint.Inclusive, RightEndpoint.Bounded) ==
    ...
    {
        return (LeftEndpoint.Point,
                LeftEndpoint.Inclusive,
                LeftEndpoint.Bounded,
                RightEndpoint.Point,
                RightEndpoint.Inclusive,
                RightEndpoint.Bounded).GetHashCode();
    }

    /// <inheritdoc/>
    public override string ToString()
    {
        string openParens = LeftEndpoint.Inclusive ? "[" : "(";
        string min = TimeSpanToString(LeftEndpoint.Point);
        string max = TimeSpanToString(RightEndpoint.Point);
        string closeParens = RightEndpoint.Inclusive ? "]" : ")";
    ...
    {
        return new((long)Math.Round(span.Ticks * factor));
    }
