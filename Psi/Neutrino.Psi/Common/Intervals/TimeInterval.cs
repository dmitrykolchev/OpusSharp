// <copyright file="TimeInterval.cs">
...
public class TimeInterval : Interval<DateTime, TimeSpan, IntervalEndpoint<DateTime>, TimeInterval>
{
    ...
    {
        return Merge(intervals, (left, right) => new TimeInterval(left, right));
    }
    ...
    {
        return new(left, inclusive, true, DateTime.MaxValue, false, false);
    }
    ...
    {
        return new(DateTime.MinValue, false, false, right, inclusive, true);
    }
    ...
    {
        return Intersection(new List<TimeInterval>() { this, timeInterval });
    }
    ...
    {
        return Translate(span, (lp, li, lb, rp, ri, rb) => new TimeInterval(lp, li, lb, rp, ri, rb));
    }
    ...
    {
        return Scale(left, right, (lp, li, lb, rp, ri, rb) => new TimeInterval(lp, li, lb, rp, ri, rb));
    }
