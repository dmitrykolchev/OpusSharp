...
public class IntInterval : Interval<int, int, IntervalEndpoint<int>, IntInterval>
{
    ...
    {
        return Merge(intervals, (left, right) => new IntInterval(left, right));
    }
    ...
    {
        return new(left, inclusive, true, int.MaxValue, false, false);
    }
    ...
    {
        return new(int.MinValue, false, false, right, inclusive, true);
    }
    ...
    {
        return Translate(span, (lp, li, lb, rp, ri, rb) => new IntInterval(lp, li, lb, rp, ri, rb));
    }
    ...
    {
        return Scale(left, right, (lp, li, lb, rp, ri, rb) => new IntInterval(lp, li, lb, rp, ri, rb));
    }
