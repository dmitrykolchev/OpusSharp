...
internal static class Time
{
    ...
    /// </summary>
    private static TickCalibration s_tickCalibration = new TickCalibration(
    ...
    {
        long ft = s_tickCalibration.ConvertToFileTime(ticksFromSystemBoot);
        return DateTime.FromFileTimeUtc(ft);
    }
    ...
    {
        uint ms = (uint)Math.Round(delay.TotalMilliseconds);
