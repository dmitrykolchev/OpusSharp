// <copyright file="DiagnosticsQueryExtensions.cs">
...
public static class DiagnosticsQueryExtensions
{
    ...
    public static IEnumerable<PipelineDiagnostics> GetAllPipelineDiagnostics(this PipelineDiagnostics pipeline)
    {
        ...
        foreach (PipelineDiagnostics child in pipeline.SubpipelineDiagnostics)
        {
            foreach (PipelineDiagnostics descendant in child.GetAllPipelineDiagnostics())
            {
    ...
    {
        foreach (PipelineDiagnostics p in pipelines)
        {
            foreach (PipelineDiagnostics.PipelineElementDiagnostics pe in p.PipelineElements)
            {
                yield return pe;
            }
        }
    ...
    {
        foreach (PipelineDiagnostics.PipelineElementDiagnostics pe in pipelineElements)
        {
            foreach (PipelineDiagnostics.EmitterDiagnostics e in pe.Emitters)
            {
                yield return e;
            }
        }
    ...
    public static IEnumerable<PipelineDiagnostics.ReceiverDiagnostics> GetAllReceiverDiagnostics(this IEnumerable<PipelineDiagnostics.PipelineElementDiagnostics> pipelineElements)
    {
        foreach (PipelineDiagnostics.PipelineElementDiagnostics pe in pipelineElements)
        {
            foreach (PipelineDiagnostics.ReceiverDiagnostics r in pe.Receivers)
            {
                yield return r;
            }
        }
