// <copyright file="ConfigurationHelper.cs">
...
public static class ConfigurationHelper
{
    ...
    {
        return ReadFromXml<T>(stream, extraTypes);
    }
    ...
    {
        WriteToXml<T>(configuration, stream, true, extraTypes);
    }
    ...
    {
        XmlSerializer xmlSerializer = new(typeof(T), extraTypes);
