// <copyright file="PlatformResources.cs">
...
namespace Neutrino.Psi.Configuration;
...
public static class PlatformResources
{
    ...
    {
        return (T)Resources[typeof(T)][Default];
    }
    ...
    {
        return TryGet(Default, out value);
    }
    ...
    {
        return Resources.ContainsKey(typeof(T)) && Resources[typeof(T)].ContainsKey(name);
    }
    ...
    {
        return Resources.ContainsKey(typeof(T)) ? Resources[typeof(T)].Keys : Enumerable.Empty<string>();
    }
}
