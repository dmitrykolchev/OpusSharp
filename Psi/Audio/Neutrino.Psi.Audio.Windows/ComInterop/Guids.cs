...
internal static class Guids
{
    ...
    /// </summary>
    internal static readonly Guid MFMediaTypeAudio = new(0x73647561, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xAA, 0x00, 0x38, 0x9B, 0x71);

    /// <summary>
    /// MF_MT_MAJOR_TYPE {48eba18e-f8c9-4687-bf11-0a74c9f96a8f} (defined in mfapi.h).
    /// </summary>
    internal static readonly Guid MFMTMajorType = new(0x48eba18e, 0xf8c9, 0x4687, 0xbf, 0x11, 0x0a, 0x74, 0xc9, 0xf9, 0x6a, 0x8f);

    /// <summary>
    /// MF_MT_SUBTYPE {f7e34c9a-42e8-4714-b74b-cb29d72c35e5} (defined in mfapi.h).
    /// </summary>
    internal static readonly Guid MFMTSubType = new(0xf7e34c9a, 0x42e8, 0x4714, 0xb7, 0x4b, 0xcb, 0x29, 0xd7, 0x2c, 0x35, 0xe5);

    /// <summary>
    /// MF_MT_AUDIO_NUM_CHANNELS {37e48bf5-645e-4c5b-89de-ada9e29b696a} (defined in mfapi.h).
    /// </summary>
    internal static readonly Guid MFMTAudioNumChannels = new(0x37e48bf5, 0x645e, 0x4c5b, 0x89, 0xde, 0xad, 0xa9, 0xe2, 0x9b, 0x69, 0x6a);

    /// <summary>
    /// MF_MT_AUDIO_SAMPLES_PER_SECOND {5faeeae7-0290-4c31-9e8a-c534f68d9dba} (defined in mfapi.h).
    /// </summary>
    internal static readonly Guid MFMTAudioSamplesPerSecond = new(0x5faeeae7, 0x0290, 0x4c31, 0x9e, 0x8a, 0xc5, 0x34, 0xf6, 0x8d, 0x9d, 0xba);

    /// <summary>
    /// MF_MT_AUDIO_BLOCK_ALIGNMENT {322de230-9eeb-43bd-ab7a-ff412251541d} (defined in mfapi.h).
    /// </summary>
    internal static readonly Guid MFMTAudioBlockAlignment = new(0x322de230, 0x9eeb, 0x43bd, 0xab, 0x7a, 0xff, 0x41, 0x22, 0x51, 0x54, 0x1d);

    /// <summary>
    /// MF_MT_AUDIO_AVG_BYTES_PER_SECOND {1aab75c8-cfef-451c-ab95-ac034b8e1731} (defined in mfapi.h).
    /// </summary>
    internal static readonly Guid MFMTAudioAvgBytesPerSecond = new(0x1aab75c8, 0xcfef, 0x451c, 0xab, 0x95, 0xac, 0x03, 0x4b, 0x8e, 0x17, 0x31);

    /// <summary>
    /// MF_MT_AUDIO_BITS_PER_SAMPLE {f2deb57f-40fa-4764-aa33-ed4f2d1ff669} (defined in mfapi.h).
    /// </summary>
    internal static readonly Guid MFMTAudioBitsPerSample = new(0xf2deb57f, 0x40fa, 0x4764, 0xaa, 0x33, 0xed, 0x4f, 0x2d, 0x1f, 0xf6, 0x69);

    /// <summary>
    /// MF_MT_ALL_SAMPLES_INDEPENDENT {c9173739-5e56-461c-b713-46fb995cb95f} (defined in mfapi.h).
    /// </summary>
    internal static readonly Guid MFMTAllSamplesIndependent = new(0xc9173739, 0x5e56, 0x461c, 0xb7, 0x13, 0x46, 0xfb, 0x99, 0x5c, 0xb9, 0x5f);

    /// <summary>
    /// KSDATAFORMAT_SUBTYPE_PCM {"00000001-0000-0010-8000-00aa00389b71"} (defined in mmreg.h).
    /// </summary>
    internal static readonly Guid KSDataFormatSubTypePCM = new("00000001-0000-0010-8000-00aa00389b71");
