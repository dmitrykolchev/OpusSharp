// <copyright file="AudioVolumeNotificationData.cs">
...
internal class AudioVolumeNotificationData
{
    ...
    internal static AudioVolumeNotificationData MarshalFromPtr(IntPtr ptr)
    {
        ...
        IntPtr channelVolumesPtr = new(ptr.ToInt64() + Marshal.OffsetOf<AudioVolumeNotificationDataStruct>("ChannelVolume0").ToInt64());
        ...
        AudioVolumeNotificationData notificationData = new()
        {
