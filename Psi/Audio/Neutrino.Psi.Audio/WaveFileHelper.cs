// <copyright file="WaveFileHelper.cs">
...
public static class WaveFileHelper
{
    ...
    {
        using BinaryReader br = new(new FileStream(filename, FileMode.Open, FileAccess.Read, FileShare.Read));
    ...
    {
        string name = Encoding.UTF8.GetString(BitConverter.GetBytes(br.ReadInt32()));
        if (name != "data")
        {
