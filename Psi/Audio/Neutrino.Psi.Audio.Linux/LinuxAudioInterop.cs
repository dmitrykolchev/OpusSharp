// <copyright file="LinuxAudioInterop.cs">
...
internal static class LinuxAudioInterop
{
    ...
    private static void CheckResult(long result, string message)
    {
        ...
        {
            Debug.Print($"Error code: {result}, {message}");
        }
    }
    ...
    private const string LibASound = "asound";

    private static class NativeMethods
    {
        [DllImport(LibASound, EntryPoint = "snd_pcm_open", BestFitMapping = false, ThrowOnUnmappableChar = true)]
