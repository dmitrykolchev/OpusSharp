// <copyright file="AlsaApiTable.cs">
...
internal unsafe class AlsaApiTable : ApiTable
{
    private AlsaApiTable(nint module) : base(module)
    {
    }

    public static AlsaApiTable Load(string libraryName)
    {
        nint libraryHandle = NativeLibrary.Load(libraryName);
        return new AlsaApiTable(libraryHandle);
    }
    /**
     * \file include/pcm.h
    ...
    /// PCM subclass
    /// </summary>
    public enum snd_pcm_subclass_t
    {
    ...
    /// </summary>
    public enum snd_pcm_subformat_t
    {
        /** Unknown */
    ...
    /// PCM timestamp type
    /// </summary>
    public enum snd_pcm_tstamp_type_t
    {
    ...
    /// </summary>
    public enum snd_pcm_audio_tstamp_type_t
    {
        /**
    ...
    public struct snd_pcm_audio_tstamp_config_t
    {
        public uint data;

        /* 5 of max 16 bits used */
        private uint type_requested => (data >> 0) & 0xFu; // requested audio tstamp type

        private uint report_delay => (data >> 4) & 1; // add total delay to A/D or D/A
    }
    ...
    /// </summary>
    public struct snd_pcm_audio_tstamp_report_t
    {
        public uint data;

        /* 6 of max 16 bits used for bit-fields */
        private uint valid => (data >> 0) & 0x01;           // for backwards compatibility

        private uint actual_type => (data >> 1) & 0x0F;      // actual type if hardware could not support requested timestamp 

        private uint accuracy_report => (data >> 5) & 0x01; // 0 if accuracy unknown, 1 if accuracy field is valid 

        private uint accuracy => data >> 6;                 // up to 4.29s in ns units, will be packed in separate field 
    }
    ...
    /// </summary>
    public const int SND_PCM_EINTR = 0x00000080;
    /// <summary>
    /// In an abort state (internal, not allowed for open)
    /// </summary>
    public const int SND_PCM_ABORT = 0x00008000;
    /// <summary>
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    public struct snd_pcm_channel_area_t
    {
        /** base address of channel samples */
        private readonly void* addr;
    ...
    public struct snd_pcm_sync_id_t
    {
        /** 8-bit ID */
        [FieldOffset(0)]
    ...
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t**, byte*, snd_pcm_stream_t, int, int> snd_pcm_open;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t**, byte*, snd_pcm_stream_t, int, snd_config_t*, int> snd_pcm_open_lconf;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t**, snd_config_t*, byte*, byte*, snd_pcm_stream_t, int, int> snd_pcm_open_fallback;

    // int snd_pcm_close(snd_pcm_t* pcm);
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, int> snd_pcm_close;

    // const char* snd_pcm_name(snd_pcm_t * pcm);
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, byte*> snd_pcm_name;

    // snd_pcm_type_t snd_pcm_type(snd_pcm_t* pcm);
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, snd_pcm_type_t> snd_pcm_type;

    // snd_pcm_stream_t snd_pcm_stream(snd_pcm_t* pcm);
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, snd_pcm_stream_t> snd_pcm_stream;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, pollfd*, uint, int> snd_pcm_poll_descriptors;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, nint, int> snd_pcm_hw_params_current;

    //int snd_pcm_hw_params(snd_pcm_t* pcm, snd_pcm_hw_params_t*params);
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, nint, int> snd_pcm_hw_params;

    //int snd_pcm_hw_free(snd_pcm_t* pcm);
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, int> snd_pcm_hw_free;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, int> snd_pcm_prepare;

    //int snd_pcm_reset(snd_pcm_t* pcm);
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, int> snd_pcm_reset;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, int> snd_pcm_start;

    //int snd_pcm_drop(snd_pcm_t* pcm);
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, int> snd_pcm_drop;

    //int snd_pcm_drain(snd_pcm_t* pcm);
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, int> snd_pcm_drain;
    ...
    [Import(Name = "snd_pcm_writei")]
    private delegate* unmanaged[Cdecl]
        <snd_pcm_t*, byte*, ulong, long> snd_pcm_writei64;
    [Import(Name = "snd_pcm_writei")]
    private delegate* unmanaged[Cdecl]
        <snd_pcm_t*, byte*, uint, int> snd_pcm_writei32;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public unsafe long snd_pcm_writei(snd_pcm_t* pcm, byte* buffer, ulong size)
    {
        if (Environment.Is64BitOperatingSystem)
        {
            long writtenFrames = snd_pcm_writei64(pcm, buffer, size);
            return writtenFrames;
        }
        else
        {
            int writtenFrames = snd_pcm_writei32(pcm, buffer, checked((uint)size));
            return writtenFrames;
        }
    }
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, nint, int> snd_pcm_hw_params_any;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <nint*, int> snd_pcm_hw_params_malloc;

    //void snd_pcm_hw_params_free(snd_pcm_hw_params_t* obj);
    [Import]
    public delegate* unmanaged[Cdecl]
        <nint, void> snd_pcm_hw_params_free;

    //void snd_pcm_hw_params_copy(snd_pcm_hw_params_t* dst, const snd_pcm_hw_params_t* src);
    [Import]
    public delegate* unmanaged[Cdecl]
        <nint*, nint*, void> snd_pcm_hw_params_copy;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, nint, snd_pcm_access_t, int> snd_pcm_hw_params_set_access;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, nint, snd_pcm_format_t, int> snd_pcm_hw_params_set_format;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, nint, uint*, int> snd_pcm_hw_params_get_channels;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, nint, uint, int> snd_pcm_hw_params_set_channels;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, nint, uint, int, int> snd_pcm_hw_params_set_rate;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <snd_pcm_t*, nint, uint*, int*, int> snd_pcm_hw_params_set_rate_near;
    ...
    [Import]
    public delegate* unmanaged[Cdecl]
        <nint, ulong*, int*, int> snd_pcm_hw_params_get_period_size;
